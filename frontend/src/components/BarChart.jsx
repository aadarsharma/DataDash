...
const BarChart = ({ selectedMonth }) => {
    ...
    return (
        <div className="chart-container p-6 max-w-5xl mx-auto bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-center mb-4">Bar Chart Stats - {monthName}</h2>
